...
public class CalculateLTBPvtCar {


    private final String TAG = "CalculateLTBPvtCar";
    /**
     * Entry Fields
     */
    private int age;
    ...
    public CalculateLTBPvtCar(int age, int zone, int cc, int idv, int lpg_cng, int buitlInLPG, int tape, int towing, int ncb,
    ...
    public void calculateInsurance(){
        ...
        switch (zone){
            case 1:
                switch(this.cc){
                    case 1: mTP = 6521; mBasic = to2decimal(0.025f * (float)idv);  break;
                    case 2: mTP = 10640; mBasic = to2decimal(0.0262f * (float)idv); break;
                    case 3: mTP = 24596; mBasic = to2decimal(0.027f * (float)idv); break;
                }
                ...
                if(pa_to_pass!=0)
                    mPassPa = 3 * 5 * pa_to_pass * pa_amount/10000;
            ...
            case 2:
                switch(this.cc){
                    case 1: mTP = 6521; mBasic = to2decimal(0.022f * (float)idv);  break;
                    case 2: mTP = 10640; mBasic = to2decimal(0.0252f * (float)idv); break;
                    case 3: mTP = 24596; mBasic = to2decimal(0.0234f * (float)idv); break;
                }
            ...
            case 3:
                switch(this.cc){
                    case 1: mTP = 6521; mBasic = to2decimal(0.0219f * (float)idv);  break;
                    case 2: mTP = 10640; mBasic = to2decimal(0.0243f * (float)idv); break;
                    case 3: mTP = 24596; mBasic = to2decimal(0.0225f * (float)idv); break;
                }
            ...
            case 4:
                switch(this.cc){
                    case 1: mTP = 6521; mBasic = to2decimal(0.0207f * (float)idv);  break;
                    case 2: mTP = 10640; mBasic = to2decimal(0.0225f * (float)idv); break;
                    case 3: mTP = 24596; mBasic = to2decimal(0.0224f * (float)idv); break;
                }
