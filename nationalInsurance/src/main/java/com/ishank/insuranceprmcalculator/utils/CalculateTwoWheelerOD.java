...
public class CalculateTwoWheelerOD {

    private final String TAG = "CalculateTwoWheelerOD";
    /**
     * Entry Fields
     */
    private int age;
...
//    private float mPassPa;
    ...
    public CalculateTwoWheelerOD(@NonNull int age, @NonNull int zone, @NonNull int cc, @Nullable int idv, int ncb, int nil_dep, float discount, int engine_protect,int ncb_protect, int invoice_protect){
...
//                    mGST = mTotal * 0.09f;
                    mGST = mNET_OD * 0.09f;
                    mNet_Payable = 2 * Math.round(mGST) + mNET_OD;
                    break;
