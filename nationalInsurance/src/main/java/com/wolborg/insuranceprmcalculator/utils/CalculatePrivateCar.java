...
public class CalculatePrivateCar {
    ...
    public void calculateInsurance(){
        ...
        switch (zone){
            case 1:
                switch(this.cc){
                    case 1: mTP = 2094; mBasic = to2decimal(0.025f * (float)idv);  break;
                    case 2: mTP = 3416; mBasic = to2decimal(0.0262f * (float)idv); break;
                    case 3: mTP = 7897; mBasic = to2decimal(0.027f * (float)idv); break;
                }
            ...
            case 2:
                switch(this.cc){
                case 1: mTP = 2094; mBasic = to2decimal(0.022f * (float)idv);  break;
                case 2: mTP = 3416; mBasic = to2decimal(0.0252f * (float)idv); break;
                case 3: mTP = 7897; mBasic = to2decimal(0.0234f * (float)idv); break;
            }
            ...
            case 3:
                switch(this.cc){
                    case 1: mTP = 2094; mBasic = to2decimal(0.0219f * (float)idv);  break;
                    case 2: mTP = 3416; mBasic = to2decimal(0.0243f * (float)idv); break;
                    case 3: mTP = 7897; mBasic = to2decimal(0.0225f * (float)idv); break;
                }
            ...
            case 4:
                switch(this.cc){
                    case 1: mTP = 2094; mBasic = to2decimal(0.0207f * (float)idv);  break;
                    case 2: mTP = 3416; mBasic = to2decimal(0.0225f * (float)idv); break;
                    case 3: mTP = 7897; mBasic = to2decimal(0.0224f * (float)idv); break;
                }
