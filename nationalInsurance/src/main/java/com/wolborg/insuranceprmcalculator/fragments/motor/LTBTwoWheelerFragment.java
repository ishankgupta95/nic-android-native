...
import com.wolborg.insuranceprmcalculator.dialog.Learn;
import com.wolborg.insuranceprmcalculator.dialog.SpinnerError;

import java.math.BigDecimal;

public class LTBTwoWheelerFragment extends Motor {

    public static final String TAG = "LTBTwoWheelerFragment";
